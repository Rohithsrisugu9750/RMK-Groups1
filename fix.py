...
with open('admin-billing.html', 'r', encoding='utf8') as f:
    text = f.read()

start_marker = '    <!-- Create Invoice Modal -->\n    <div class="modal" id="invoiceModal">'
end_marker = '    <!-- Record Payment Modal -->'

if start_marker in text and end_marker in text:
    start_idx = text.find(start_marker)
    end_idx = text.find(end_marker)
    
    new_modal = '''    <!-- Create Invoice Modal -->
    <div class="modal" id="invoiceModal">
...
'''
    ...
    new_text = text[:start_idx] + new_modal + text[end_idx:]
    with open('admin-billing.html', 'w', encoding='utf8') as f:
        f.write(new_text)
    print('Successfully replaced invoiceModal!')
else:
